...
import com.scohe.iroms.orientintelligent.utils.FastJsonUtil;
...
public class BlockChain {
    ...
    public String getHash() {
        String json = JSONObject.toJSONString(this.getCurrentTransactions()) +
    ...
    public boolean resolveConflicts() {
        ...
        for (String node : getNodes()) {
            ...
            String json = FastJsonUtil.toJson(MapUtils.getObject(map, "chain"));
            List<BlockChain> chain = FastJsonUtil.fromJson(json, new TypeReference<List<BlockChain>>() {
            });
